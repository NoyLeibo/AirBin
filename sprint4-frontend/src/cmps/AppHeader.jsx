...
export function AppHeader() {
  ...
  return (
    <header
      className={
        !isScrolledDown ? "app-header grid header-inserted" : "app-header grid"
      }
    >
      ...
      <div className="header-content">
        ...
        <div
          className={
            !isScrolledDown
              ? "small-search-form flex align-center small-form-expended"
        ...
        <nav
          className={
            !isScrolledDown
              ? "mid-three-menu flex column justify-center mid-header mid-three-menu-close"
      ...
      <div className="flex justify-center">
        <form
          className={
            !isScrolledDown
              ? "search-form justify-center flex row header-search-inserted"
